...
const dir = fs.readdirSync(pnpmStore).find((d) => d.startsWith("@sqlite.org+sqlite-wasm@"));
...
const src = path.join(pnpmStore, dir, "node_modules/@sqlite.org/sqlite-wasm/dist/sqlite3.wasm");
const dest = path.join(root, "dist", "sqlite3.wasm");
const destChunks = path.join(root, "dist", "_expo", "static", "js", "web", "sqlite3.wasm");
